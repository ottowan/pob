<?php
  ...
  */
  function POBClient_user_main() {
    POBClient_permission();
    return POBClient_user_list();
  }

  /**
  * display page with out class loader
  */
  function POBClient_user_page() {
    POBClient_permission();
    //$ctrl the class name
  ...
  */
  function POBClient_user_list() {
    ...
    $class = Loader::loadClassFromModule ('POBClient', $ctrl, true);
    if ($class){
    ...
    return $render->fetch('user_'.$func.'_'.strtolower($ctrl).'.htm');
      ...
      /**
        ...
        */
  function POBClient_user_delete() {
    POBClient_permission();
    $ctrl    = FormUtil::getPassedValue ('ctrl', false , 'GET');
    $id      = FormUtil::getPassedValue ('id', null , 'GET');
