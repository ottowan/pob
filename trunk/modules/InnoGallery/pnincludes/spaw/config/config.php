...
// toolbarset 
SpawConfig::setStaticConfigItem('default_toolbarset','mini'); //all, mini , standard
// stylesheet
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/flash_x/',
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/images_x/',
      'caption' => 'Images',
      'params'  => array(
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/files_x/',
      'fsdir'   => SpawConfig::getStaticConfigValue('SPAW_ROOT').'uploads/files_x/', // optional absolute physical filesystem path
      'caption' => 'Files', 
      'params'  => array(
...
// directories
$flashdir = defined ('SPAW_UPLOAD_FLASH_PATH') ? SPAW_UPLOAD_FLASH_PATH: SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/flashs/';
$imagedir = defined ('SPAW_UPLOAD_IMAGE_PATH') ? SPAW_UPLOAD_IMAGE_PATH: SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/images/';
