 ...
 * @version $Id: pninit.php,v 1.1 2009/06/26 05:17:21 chongasem Exp $
        ...
        foreach ($userArray as $user) {
            foreach ($columnArray as $column) {
                if ($column != 'uid' &&
					...
					$sql = 'INSERT INTO '.$pntable['user_data'].' SET '.$datacolumns['uda_propid'].'='.$properties[$var].', '.$datacolumns['uda_uid'].'='.$user[uid].', '.$datacolumns['uda_value'].'=\''.DataUtil::formatForStore($user[$column]).'\'';
