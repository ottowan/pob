 ...
 * @version $Id: admin.php,v 1.1 2009/06/26 05:17:22 chongasem Exp $
...
define('_USERS_NEWUSER', 'ผู้ใช้ใหม่');
...
// singular/plural
define('_USERS_USER', 'ผู้ใช้');
define('_USERS_USER_LC', 'ผู้ใช้');
...
define('_SEARCHUSERS', 'ค้นหาผู้ใช้');
define('_USERPROPERTIES', 'User Properties');
define('_USERS_VIEWUSERS', 'ดูผู้ใช้ทั้งหมด');
define('_USERS_CREATEUSER', 'สร้างผู้ใช้');
define('_USERS_MODIFYUSER', 'แก้ไขผู้ใช้');
define('_USERS_DELETEUSER', 'ลบผู้ใช้');
...
// new/modify template
define('_USERS_GROUP', 'กลุ่ม');
define('_USERS_GROUPMEMBERSHIP', 'สมาชิกกลุ่ม');
define('_USERS_MEMBEROF', 'สมาชิก');
...
define('_USERS_STATUS', 'สถานะผู้ใช้');
define('_USERS_USERGROUPIS', 'สมาชิกกลุ่ม');
...
define('_USERS_SEARCHRESULTS', 'ผลการค้นหา');
