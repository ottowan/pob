...
// general
define('_USERS', 'บัญชีผู้ใช้');

// view template
define('_USERS_REGISTER', 'ลงทะเบียน');
...
define('_USERS_MUSTBE', 'ท่านต้องอายุมากกว่า %a%  ปี หรือแก่กว่า, จึงจะสามารถสมัครเป็นสมาชิกได้ โดยเลือกหัวข้อตามที่ระบุคือ:');
define('_USERS_OVERAGE', 'ข้าพเจ้าอายุ มากกว่า  %a% ปี, หรือมีผู้ปกครองยินยอมให้สมัคร');
define('_USERS_REGISTRATION', 'New Account Registration');
define('_USERS_UNDERAGE', 'ข้าพเจ้าอายุน้อยกว่า %a% ปี, และไม่มีผู้ปกครองยินยอมให้สมัคร');
...
define('_USERS_REG_STEP1', 'ขั้นที่1: ใส่ชื่อของคุณ');
define('_USERS_REG_STEP2', 'ขั้นที่ 2: ใส่อีเมลล์ของคุณ');
