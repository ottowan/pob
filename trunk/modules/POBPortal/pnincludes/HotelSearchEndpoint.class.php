...
/*
      $Rating = $Property[$i]->MultimediaDescriptions->MultimediaDescription[$m]->TextItems->TextItem->attributes()->Title;
      if($Rating == "Rating"){
        $repackArray["Properties"][$i]["Rating"] = $Rating->Description;
      }
*/
