 ...
 */
function POBRoomSearch_SearchRoomblock_init()
{
 ...
 */
function POBRoomSearch_SearchRoomblock_info()
{
    return array('text_type'      => 'Search Room',
                 'module'         => 'POBRoomSearch',
                 'text_type_long' => 'Search Room',
                 'allow_multiple' => true,
                 'form_content'   => false,
                 'form_refresh'   => false,
                 'show_preview'   => true);
 ...
 */
function POBRoomSearch_SearchRoomblock_display($blockinfo)
{
    $modname  = 'POBRoomSearch';
    $class    = 'SearchRoomblock';
    ...
    $blockinfo['content'] = $render->fetch('block_searchroom.htm');
 ...
 */
function POBRoomSearch_SearchRoomblock_modify($blockinfo)
{
  $vars = pnBlockVarsFromContent($blockinfo['content']);
  //load render
  ...
  $render->assign('form', $vars);
	...
	return $render->fetch('block_searchroom_modify.htm');
}
 ...
 */
function POBRoomSearch_SearchRoomblock_update($blockinfo)
{
    ...
    $pnRender->clear_cache('block_searchroom.htm');
