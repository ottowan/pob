 ...
 * @link        $HeadURL: https://code.zikula.org/svn/soundwebdevelopment/tags/PostCalendar620/pnadminapi.php $
 * @version     $Id: pnadminapi.php 748 2010-07-27 11:49:09Z craigh $
...
function postcalendar_adminapi_getlinks()
{
    ...
    if (SecurityUtil::checkPermission('PostCalendar::', '::', ACCESS_ADMIN)) {
        $links[] = array(
            'url' => pnModURL('PostCalendar', 'admin', 'modifyeventdefaults'),
    ...
    if (SecurityUtil::checkPermission('PostCalendar::', '::', ACCESS_ADD)) {
        $links[] = array(
            'url' => 'http://code.zikula.org/soundwebdevelopment/wiki/PostCalendarFeatureDocs62',
            'text' => __('Documentation', $dom));
    }
...
function postcalendar_adminapi_notify($args)
{
    ...
    $render->assign('link', pnModURL('PostCalendar', 'admin', 'adminevents', array(
        'events' => $eid,
