<?php
  ...
  */
  function Serialize_permission() {
    ...
    if (!SecurityUtil::checkPermission('Serialize::', '::', ACCESS_ADMIN)) {
  ...
  */
  function Serialize_admin_main() {
    Serialize_permission();
    return Serialize_admin_list();
  }

  /**
  * display page with out class loader
  */
  function Serialize_admin_page() {
    Serialize_permission();
    //$ctrl the class name
  ...
  function Serialize_admin_list() {
    ...
    return $render->fetch('admin_'.$func.'_'.strtolower($ctrl).'.htm');
      ...
      /**
        ...
        */
  function Serialize_admin_delete() {
    Serialize_permission();
    $ctrl    = FormUtil::getPassedValue ('ctrl', false , 'GET');
    $id      = FormUtil::getPassedValue ('id', null , 'GET');
