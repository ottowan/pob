  ...
  function Serialize_adminform_submit()
  {
    ...
    if (empty($ctrl)){
      if ($form[ctrl]){
        ...
        return 'ERROR Serialize system can not find controller variable';
      }
    }

    //Forward page and select value
    $list_url = pnModURL('Serialize', 'admin', 'list' , array('ctrl'   => $ctrl));
    ...
    if (!($class = Loader::loadClassFromModule ('Serialize', $ctrl , $is_array))){
