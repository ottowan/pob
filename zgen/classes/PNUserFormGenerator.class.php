...
class PNUserFormGenerator{
  ...
  function __construct($module, $mindmap) {
      ...
      $this->filePath = "pnuserform.php";
      $this->newFilePath = $module."/"."pnuserform.php";
  }

  function createPNUserFormFile() {
  ...
  function createPermissionMethodCode() {
    ...
    $code .= "    //we are allow for user access level , see in config.php variable name ACCESS_COMMENT";$code .= "\r\n";
  ...
  function createMainMethodCode() {
    $code .= "  function ".$this->module."_userform_main (){";$code .= "\r\n";
    $code .= "    ".$this->module."_permission();";$code .= "\r\n";
    $code .= "    ".$this->module."_userform_submit ();";$code .= "\r\n";
    $code .= "  }";$code .= "\r\n";$code .= "\r\n";
  ...
  function createSubmitMethodCode() {
    $code .= "  function ".$this->module."_userform_submit()";$code .= "\r\n";
    $code .= "  {";$code .= "\r\n";
    $code .= "    ".$this->module."_permission();";$code .= "\r\n";
    ...
    $code .= "    \$list_url = pnModURL('".$this->module."', 'user', 'list' , array('ctrl'   => \$ctrl));";$code .= "\r\n";
    $code .= "";$code .= "\r\n";
