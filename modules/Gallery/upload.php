...
$script_dir_url = "http://".$_SERVER['SERVER_NAME'];

//$script_dir_url = dirname($_SERVER['PHP_SELF']);

$hotelcode = $_REQUEST['hc'];
$options = array(
    'upload_dir' => $script_dir.'/gallery/files/'.$hotelcode.'/',
    'upload_url' => $script_dir_url.'/gallery/files/'.$hotelcode.'/',
    'thumbnails_dir' => $script_dir.'/gallery/thumbnails/'.$hotelcode.'/',
    'thumbnails_url' => $script_dir_url.'/gallery/thumbnails/'.$hotelcode.'/',
