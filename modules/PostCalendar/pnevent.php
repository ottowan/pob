 ...
 * @link        $HeadURL: https://code.zikula.org/svn/soundwebdevelopment/tags/PostCalendar620/pnevent.php $
 * @version     $Id: pnevent.php 622 2010-06-26 21:26:15Z craigh $
...
function postcalendar_event_new($args)
{
    ...
    if (($form_action == 'preview') || ($form_action == 'save')) {
        ...
        $submitted_event = pnModApiFunc('PostCalendar', 'event', 'correctlocationdata', $submitted_event);
    }
