 ...
 * @link        $HeadURL: https://code.zikula.org/svn/soundwebdevelopment/tags/PostCalendar620/pninit.php $
 * @version     $Id: pninit.php 765 2010-08-11 02:30:48Z craigh $
...
function PostCalendar_upgrade($oldversion)
{
    ...
    switch ($oldversion) {
        ...
        case '6.1.0':
            $oldDefaultCats = pnModGetVar('PostCalendar', 'pcDefaultCategories');
            pnModDelVar('PostCalendar', 'pcDefaultCategories');
            $defaults = postcalendar_init_getdefaults();
            $defaults['pcEventDefaults']['categories'] = $oldDefaultCats;
            pnModSetVar('PostCalendar', 'pcEventDefaults', $defaults['pcEventDefaults']);
        case '6.2.0':
            //future development
    }
...
function postcalendar_init_getdefaults()
{
    ...
    $Zlang = new Zlanguage;
    $i18n = new ZI18n($Zlang->getLocale());
