<?php
  ...
  * 
  */
Class HotelLimitSearchEndpoint {
  ...
  public function setHotelLimitSearchXML( $location  = NULL,  $distance  = 0, $latitude  = NULL, $longitude = NULL, $startDate = NULL, $endDate   = NULL, $limit = NULL, $offset = NULL){
  ...
  public function genHotelLimitSearchXML(){
    ...
    if($this->limit && $this->offset){
      ...
      $Select->setAttribute("Limit", $this->limit);
      $Select->setAttribute("Offset", $this->offset);
      $Criterion->appendChild($Select);
    }
  ...
  public function hotelLimitSearchTemp(){
  ...
  public function getHotelLimitSearchXML(){
    ...
    $response = $this->sendHotelLimitSearchXML();
    //print $response; exit;
  ...
  public function repackArrayLimitForDisplay($originalArray){
