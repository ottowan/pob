 ...
 */
function POBPortal_SearchHotelLeftblock_init()
{
 ...
 */
function POBPortal_SearchHotelLeftblock_info()
{
    return array('text_type'      => 'Search Hotel left',
                 'module'         => 'POBPortal',
                 'text_type_long' => 'Search Hotel left',
                 'allow_multiple' => true,
                 'form_content'   => false,
                 'form_refresh'   => false,
                 'show_preview'   => true);
 ...
 */
function POBPortal_SearchHotelLeftblock_display($blockinfo)
{
    $modname  = 'POBPortal';
    $class    = 'SearchHotelLeftblock';
  ...
  if (file_exists('modules/POBPortal/pnlang/' . $lang . '/user.php')){
    ...
    $blockinfo['content'] = $render->fetch('block_searchhotelleft.htm');
 ...
 */
function POBPortal_SearchHotelLeftblock_modify($blockinfo)
{
  $vars = pnBlockVarsFromContent($blockinfo['content']);
  //load render
  ...
  $render->assign('form', $vars);
	...
	return $render->fetch('block_searchhotelleft_modify.htm');
}
 ...
 */
function POBPortal_SearchHotelLeftblock_update($blockinfo)
{
    ...
    $pnRender->clear_cache('block_searchhotelleft.htm');
