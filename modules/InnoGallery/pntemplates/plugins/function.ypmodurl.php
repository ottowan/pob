 ...
 * @version $Id: function.ypmodurl.php,v 1.1 2008/12/16 08:51:25 cvsuser Exp $
 ...
 */
function smarty_function_ypmodurl ($params, &$smarty)
{
    ...
    $raw       = isset($params['raw'])  && $params['raw']  ? $params['raw']      : null;
